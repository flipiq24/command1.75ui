            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right relative">
                ...
                >
                  ...
                  <div className="absolute top-full left-0 mt-2 w-80 bg-gray-900 text-white p-4 rounded-lg shadow-xl z-30 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none text-left text-xs leading-relaxed">
                ...
                <div className="flex items-baseline justify-start gap-1 cursor-pointer transition-opacity hover:opacity-80 mt-1">
              ...
              <div className="text-right relative border-l border-gray-200 pl-6">
                ...
                >
                  ...
                  <Info className="w-3 h-3 text-gray-400" />
                  <div className="absolute top-full right-0 mt-2 w-80 bg-gray-900 text-white p-4 rounded-lg shadow-xl z-30 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none text-left text-xs leading-relaxed">
                    <div className="font-bold text-white mb-2 text-sm">
                ...
                <div className="flex items-baseline justify-end gap-1 cursor-pointer transition-opacity hover:opacity-80 mt-1">
